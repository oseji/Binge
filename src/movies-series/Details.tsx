				...
				<div>
					{mediaType === "movie" ? (
						<div>
							...
							<div className="flex flex-row justify-center w-full my-10 md:my-5">
								{!trailerLoading ? (
									<ReactPlayer
												...
												{auth.currentUser ? (
													<span>
														{ifLikedLoading ? (
															...
															<button
																className="transition duration-200 ease-in-out outline-0 hover:scale-125"
						...
						<div>
							...
							<div className=" detailsPage">
								...
								<div className=" xl:w-[70%]">
									...
									<div className="flex flex-col my-5 md:flex-row md:items-center md:gap-3">
										<div>
